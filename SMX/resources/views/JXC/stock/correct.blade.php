    ...
    <div class="row">
        ...
        <div class="sidebar col-xs-2 col-sm-3 col-md-2">
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation" class="active"><a href="#">报溢报损</a></li>
            </ul>
        </div>
        <!-- main content -->
        <div class="col-xs-9 col-sm-7 col-md-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-1">
            ...
            <div class="row">
                <form class="form-horizontal" method="POST"
                    ...
                    <div class="form-group">
                        <label for="inputParent" class="col-sm-2 control-label">真实数量</label>
                        <!-- Single button -->
                        <div class="col-sm-8 col-md-6 col-lg-8">
                            <input name="true" type="text" class="form-control"
                                   id="true"
                                   value="{{ old('true') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-success">提交单据</button>
                        </div>
                    </div>
                </form>
                @if($errors->any())
