                        ...
                        <div class="panel-body">
                            <div class="tab-wrapper tab-primary">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#import" data-toggle="tab">创建销售单</a>
                                    </li>
                                    <li ><a href="#undoimport" data-toggle="tab">创建销售退货单</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="import">
                                        <section class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" role="form" method="POST" action="{{ url('sale/export/add')}}">
                                                    <div class="col-md-1">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="form-group">
                                                            <label for="clientname" class="col-sm-3 control-label">销售商</label>
