                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/sale/client/add')}}">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-md-2 control-label" >客户等级</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="level" class="form-control" placeholder="Client Level" >
                                        </div>
                                        ...
                                        <label class="col-sm-2 col-md-2 control-label" >客户地址</label>
                                        <div class="col-sm-6">
