    ...
    <div class="row">
        ...
        <div class="sidebar col-xs-2 col-sm-3 col-md-2">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li role="presentation" class="active"><a href="#">增加客户</a></li>
        ...
        <div class="col-xs-9 col-sm-7 col-md-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-1">
            ...
            <div class="row">
                <form class="form-horizontal" method="POST"
                    ...
                    <div class="form-group">
                        {!! Form::label('level', '级别', ['class' => 'col-md-2 control-label']) !!}
                        <div class="controls">
                            <div class="ol-sm-8 col-md-6 col-lg-8">
                                <!-- Inline Radios -->
                                <label class="radio-inline">
                    ...
                    <div class="form-group">
                        <label for="limit" class="col-sm-2 control-label">额度</label>
                        <div class="col-sm-8 col-md-6 col-lg-8">
