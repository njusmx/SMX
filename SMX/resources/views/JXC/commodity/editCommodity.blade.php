                            ...
                            <div class="tab-wrapper tab-primary">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="updateCategory">
                                        <section class="panel">
                                            <div class="panel-body">
                                                <form class="form-horizontal" role="form" method="POST" action="{{ url('/stock/commodity/edit')}}">
                                                    <div class="col-md-1">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" name="name" class="form-control" readonly="readonly" value={{$commodity->name}} >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">商品型号</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" name="type" class="form-control" readonly="readonly" value={{$commodity->type}}>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">商品类别</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" name="category" class="form-control" readonly="readonly" value={{$category->name}}>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">默认进价</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" name="avgin" class="form-control"  placeholder={{$commodity->avgin}}>
                                                            </div>
                                                        </div><div class="form-group">
                                                            <label class="col-sm-4 control-label">默认售价</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" name="avgout" class="form-control"  placeholder={{$commodity->avgout}}>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">默认报警数量</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" name="lesswarn" class="form-control"  placeholder={{$commodity->lesswarn}}>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">默认积压数量</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" name="morewarn" class="form-control" placeholder={{$commodity->morewarn}}>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
