                                        ...
                                        <table class="table table-striped">
                                            ...
                                            @if (count($undos))
                                                ...
                                                @foreach ($undos as $undo)
                                                    <tr>
                                                        <td>{{ $undo->client->id }}</td>
                                                        <td>{{ $undo->client->name }}</td>
                                                        @if($undo->client->level == 1)
                                                            <td>一级</td>
                                                        @elseif($undo->client->level == 2)
                                                            <td>二级</td>
                                                        @elseif($undo->client->level == 3)
                                                            <td>三级</td>
                                                        @endif
                                                        <td>{{ $undo->client->in }}</td>
                                                        <td>{{ $undo->undocount }}</td>
                                                        <td>{{$R[$i]}}</td>
                                                        <td>{{$F[$i]}}</td>
                                                        <td>{{$M[$i]}}</td>
                                                        @if($strategy[$i] == 1)
