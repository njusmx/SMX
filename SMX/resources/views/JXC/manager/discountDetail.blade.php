                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h2  style="color: #fff;">打折促销策略详情</h2>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" method="POST" action="{{ url('manager/strategy/discount')}}">
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="start" class="form-control form_datetime" readonly="readonly" value={{$discount->start}}>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">促销结束时间</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" name="end" class="form-control form_datetime" readonly="readonly" value={{$discount->end}}>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                        ...
                        <div class="panel-body">
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $commodity->avgout * $discount->discount }}</td>
                                </tr>
