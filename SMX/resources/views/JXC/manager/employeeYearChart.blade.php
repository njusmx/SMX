                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h2  style="color: #fff;">员工历年业绩折线图</h2>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body" id="employeeYear" style="height: 400px">
                                    </div>
                                    <script src="{{ asset('js/echarts.min.js') }}"></script>
                                    <script type="text/javascript">
                                        var myChart = echarts.init(document.getElementById('employeeYear'));

                                        var timeData = ['2011','2012','2013','2014','2015','2016'];
