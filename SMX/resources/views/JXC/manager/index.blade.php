                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/manager/request/find')}}">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                             <select name="formtype" class="form-control">
                                                 ...
                                                 <option value="1">进货单</option>
                                                 <option value="2">进货退货单</option>
                                                 <option value="3">销售单</option>
                                                 <option value="4">销售退货单</option>
                                                 <option value="5">库存报溢单</option>
                                                 <option value="6">库存报损单</option>
                                             </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-5 col-md-2 col-sm-offset-5 col-sm-10">
                        ...
                        <div class="panel-body">
                            <div class="tab-wrapper tab-primary">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#needApproval" data-toggle="tab">待审批</a>
                                    </li>
                                    <li><a href="#haveApproved" data-toggle="tab">已审批</a>
                                    </li>
                                </ul>
                                <div class="tab-content">

                                    <div class="tab-pane active" id="needApproval">
                                        <section class="panel">
                                            <div class="panel-body">
                                                <div class="col-md-12">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                            <table class="table table-striped">
                                                                ...
                                                                <tbody>
{{--                                                                {{var_dump((count($imports)+count($exports)+count($stockreportforms)))}}--}}
                                                                @if (count($imports)+count($exports)+count($stockreportforms))
                                                                    @if(count($imports))
                                                                        @foreach ($imports as $import)
                                                                            @if(!$import->status)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <form role="form" action="{{ url('manager/request/approve')}}" style='display: inline' method="post">
                                                                                            <input type="hidden" name="type" value={{ $import->type }}>
                                                                                            <input type="hidden" name="form" value="进货单据">
                                                                                            <input type="hidden" name="id" value={{ $import->id }}>
                                                                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                                            <button class="btn btn-sm btn-info">通过</button>
                                                                                        </form>
                                                                                        <form action="{{ url('manager/import/edit/'.$import->id) }}" style='display: inline' method="post">
                                                                                            <input type="hidden" name="_method" value="GET">
                                                                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                                            <button class="btn btn-sm btn-danger">查看详情</button>
                                                                                        </form>
                                                                                    </td>
                                                                                </tr>
                                                                            @endif
                                                                    ...
                                                                    @if(count($exports))
                                                                        @foreach ($exports as $export)
                                                                            @if(!$export->status)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <form role="form" action="{{ url('manager/request/approve')}}" style='display: inline' method="post">
                                                                                            <input type="hidden" name="type" value={{ $export->type }}>
                                                                                            <input type="hidden" name="form" value="销售单据">
                                                                                            <input type="hidden" name="id" value={{ $export->id }}>
                                                                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                                            <button class="btn btn-sm btn-info">通过</button>
                                                                                        </form>
                                                                                        <form action="{{ url('manager/export/edit/'.$export->id) }}" style='display: inline' method="post">
                                                                                            <input type="hidden" name="_method" value="GET">
                                                                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                                            <button class="btn btn-sm btn-danger">查看详情</button>
                                                                                        </form>
                                                                        ...
                                                                        @endforeach
                                                                    @endif
                                                                    @if(count($stockreportforms))
                                                                        @foreach ($stockreportforms as $stockreportform)
                                                                            @if(!$stockreportform->status)
                                                                                <tr>
                                                                                    @if($stockreportform->type)
                                                                                        <td>KCBY-{{ $stockreportform->id }}</td>
                                                                                        <td>{{ $stockreportform->created_at }}</td>
                                                                                        <td>库存报损单</td>
                                                                                    @else
                                                                                        <td>KCBS-{{ $stockreportform->id }}</td>
                                                                                        <td>{{ $stockreportform->created_at }}</td>
                                                                                        <td>库存报溢单</td>
                                                                                    @endif
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td>{{ $stockreportform->creator }}</td>
                                                                                    <td>
                                                                                        <form role="form" action="{{ url('manager/request/approve')}}" style='display: inline' method="post">
                                                                                            <input type="hidden" name="type" value={{ $stockreportform->type }}>
                                                                                            <input type="hidden" name="form" value="库存单据">
                                                                                            <input type="hidden" name="id" value={{ $stockreportform->id }}>
                                                                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                                            <button class="btn btn-sm btn-info">通过</button>
                                                                                        </form>
                                                                                        <form action="{{ url('manager/stockreportform/edit/'.$stockreportform->id) }}" style='display: inline' method="post">
                                                                                            <input type="hidden" name="_method" value="GET">
                                                                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                                            <button class="btn btn-sm btn-danger">查看详情</button>
                                                                                        </form>
                                                                ...
                                                                @else
                                                                    <div class="alert alert-danger alert-dismissable">
                                                                        ...
                                                                        <strong>没有待审批单据列表,请管理员添加</strong>
                                                                    </div>
                                                                @endif
                                                                </tbody>
                                                            </table>
                                    ...
                                    <div class="tab-pane " id="haveApproved">
                                        <section class="panel">
                                            <div class="panel-body">
                                                <div class="col-md-12">
                                                    <div class="panel panel-default">
