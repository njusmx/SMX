                                        ...
                                        <form class="form-horizontal" role="form" method="POST" action="{{ url('manager/strategy/package')}}">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="start" class="form-control form_datetime" readonly="readonly" value={{$package->start}}>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">促销结束时间</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" name="end" class="form-control form_datetime" readonly="readonly" value={{$package->end}}>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">特价包原价</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" name="init" class="form-control" readonly="readonly" value={{$package->init}}>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="set" class="form-control" readonly="readonly" value={{$package->set}}>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                        ...
                        <div class="panel-body">
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $package->numfirst }}</td>
                                    <td>{{ $commodityfirst->avgout }}</td>
                                    <td>{{ $package->numfirst * $commodityfirst->avgout }}</td>
                                </tr>
                                <tr>
                                    <td>{{ $commoditysecond->id }}</td>
                                    <td>{{ $commoditysecond->name }}</td>
                                    <td>{{ $commoditysecond->type }}</td>
                                    <td>{{ $package->numsecond }}</td>
                                    <td>{{ $commoditysecond->avgout }}</td>
                                    <td>{{ $package->numsecond * $commoditysecond->avgout }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
