                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h2  style="color: #fff;">代金券赠送策略详情</h2>
                                        ...
                                        <form class="form-horizontal" role="form" method="POST" action="{{ url('manager/strategy/coupon')}}">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="start" class="form-control form_datetime" readonly="readonly" value={{$coupon->start}}>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">促销结束时间</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" name="end" class="form-control form_datetime" readonly="readonly" value={{$coupon->start}}>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="value" class="form-control" readonly="readonly" value={{$coupon->value}}>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="number" class="form-control" readonly="readonly" value={{$coupon->number}} >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="condition" class="form-control" readonly="readonly" value={{$coupon->condition}}>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
